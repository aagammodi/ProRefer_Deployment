...
const CompanyDetailsForm = ({
  ...
  const handleSubmitOtp = async (event) => {
    ...
    try {
      await axios
        .post("https://pro-refer-deployment-server.vercel.app/api/verifyOtpAtSignup", {
          personalOtp,
          workOtp,
        })
        .then((res) => {
    ...
    if (
      ...
      try {
        ...
        let result = await axios.post(
          "https://pro-refer-deployment-server.vercel.app/api/checkEmailExistence",
        ...
        if (result.data === "Personal email exists") {
          ...
          await axios
            .post("https://pro-refer-deployment-server.vercel.app/api/requestOtpAtSignup", {
              personalEmail,
              workEmail,
            })
            .then((res) => {
