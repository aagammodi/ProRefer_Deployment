...
const EditProfileForm = () => {
  ...
  const getDetails = async () => {
    try {
      await axios
        .post("https://pro-refer-deployment-server.vercel.app/api/getEditProfileDetails")
        .then((res) => {
  ...
  const handleGetOTP = async (event) => {
    ...
    try {
      await axios
        .post("https://pro-refer-deployment-server.vercel.app/api/requestOtp", {
          personalEmail,
  ...
  const handleSubmitOtp = async (event) => {
    ...
    try {
      await axios
        .post("https://pro-refer-deployment-server.vercel.app/api/verifyOtp", { otp })
        .then((res) => {
  ...
  const handleApplicantSubmit = async (e) => {
    try {
      ...
      if (mobileNumber && personalEmail && location) {
        await axios
          .post("https://pro-refer-deployment-server.vercel.app/api/updateApplicant", {
            mobileNumber,
            personalEmail,
            location,
            isPersonalEmailChanged,
