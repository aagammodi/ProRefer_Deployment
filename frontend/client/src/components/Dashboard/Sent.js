...
const Sent = () => {
  const viewResume = async () => {
    try {
      const response = await axios.get("https://pro-refer-deployment-server.vercel.app/api/getPdf", {
  ...
  const fetchCurrentSent = async () => {
    try {
      const response = await axios.get("https://pro-refer-deployment-server.vercel.app/api/currentsent");
  ...
  const fetchHistoricalSent = async () => {
    try {
      const response = await axios.get("https://pro-refer-deployment-server.vercel.app/api/historysent");
      const formattedData = response.data.map((obj) => {
        return {
          ...obj,
